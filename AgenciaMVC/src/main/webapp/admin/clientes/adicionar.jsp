			...
			<div class="cards">
				<div class="card text-center">
					...
					<div class="card-body card-body-add">
						<form action="../../AdicionarCliente" id="form">
							...
							<div id="floating-email" class="form-floating">
								<input type="email" id="email" name="email" class="form-control"
									placeholder="E-mail" /> <label for="last-name">E-mail</label>
							</div>
							<div id="floating-date" class="form-floating">
								<input type="date" id="date" name="date" class="form-control"
									placeholder="Sobrenome" /> <label for="last-name">Data
									de nascimento</label>
							</div>
							...
							<div id="buttons" class="d-flex">
								<input type="submit" value="Adicionar" id="btn-submit" /> <a
									id="btn-submit" href="../../Clientes">Cancelar</a>
							</div>
						</form>
