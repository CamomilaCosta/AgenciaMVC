...
CREATE TABLE `compras` (
  ...
  `tipo_pagamento` enum('Crédito','Débito','PIX','Boleto') DEFAULT NULL,
  `parcelas` tinyint DEFAULT NULL,
  `valor_compra` double DEFAULT NULL,
  PRIMARY KEY (`id_compra`),
  KEY `id_pacote` (`id_pacote`),
  KEY `id_cliente` (`id_cliente`),
  CONSTRAINT `compras_ibfk_1` FOREIGN KEY (`id_pacote`) REFERENCES `pacotes` (`id_pacote`),
...
INSERT INTO `compras` VALUES (1,1,1,'2023-10-10','Crédito',5,2984),(3,2,3,'2023-08-10','Débito',1,3334),(14,5,5,'2023-09-30','PIX',1,2478),(15,4,6,'2023-10-10','Crédito',6,5332);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `calcular_valor_compra` BEFORE INSERT ON `compras` FOR EACH ROW BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `atualizar_valor_compra` BEFORE UPDATE ON `compras` FOR EACH ROW BEGIN
